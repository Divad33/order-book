...
export function IconStar({ size = 24, className = '', style }: IconProps) {
  return (
...
export function IconStarFilled({ size = 24, className = '' }: IconProps) {
  return (
...
export function IconCalculator({ size = 24, className = '' }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function IconSignal({ size = 24, className = '', style }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
      <path d="M2 20h.01" />
      <path d="M7 20v-4" />
